				...
				<section className="mt-16 pb-20">
					<div className="mx-auto w-full px-6 xs:px-7 sm:px-10 max-w-screen-md">
						...
						<div className="mt-16 text-base leading-loose">
							<p>
								Byeバイト様のLP制作後のインタビューを行いました。以下、その内容をご紹介いたします。
							</p>
							{/* Byeバイトの実際のLPサイト */}
							<div className="mt-4">
								<a
						...
						<div className="p-4 mt-16 border border-gray-200">
							...
							<ul>
								{toc.map((item, index) => (
									<li
										className="mt-3 text-gray-400 hover:text-blue-300"
										key={`${item.id}-${index}`}
									>
						...
						<div className="mt-6 text-base leading-loose">
							<section id="Byeバイトについて" className="pt-8">
								...
								<p className="mt-4">
									あなた:
									本日はよろしくお願いいたします。まず、Byeバイト様のサービス概要についてお聞かせいただけますでしょうか？
								</p>
								<p className="mt-4">
									Byeバイト担当者様:
									こちらこそ、よろしくお願いいたします。Byeバイトは、退職代行サービスを提供しています。「働く選択を、もっと自由に」という理念のもと、誰もが気軽に新しい一歩を踏み出せる世界を目指しています。
								</p>
								<p className="mt-4">
									あなた:
								...
								<p className="mt-4">
									Byeバイト担当者様:
									働く環境で悩むのは、正社員だけではありません。アルバイトの方も同様に悩みを抱えています。しかし、既存の退職代行サービスは高額で、学生やアルバイトの方には手が届きにくい状況でした。そこで、私たちは低価格で利用できる退職代行サービスを提供したいと考えました。
								</p>
								<p className="mt-4">
									あなた:
								...
								<p className="mt-4">
									Byeバイト担当者様:
									経験豊富なスタッフが、お客様の「辞めたい」という気持ちに寄り添い、一歩を後押しすることを大切にしています。また、広告費を削減し、サイト制作やSNS運用も自社で行うことで、料金を必要最低限に抑えています。学生さん向けの学割プランもご用意しています。
								</p>
							</section>
							...
							<section id="Webサイト制作の背景" className="pt-8">
								...
								<p className="mt-4">
									あなた:
									今回、ByeバイトのLP制作をお手伝いさせていただきましたが、Webサイト制作の背景についてお聞かせいただけますでしょうか？
								</p>
								<p className="mt-4">
									Byeバイト担当者様:
								...
								<p className="mt-4">
									あなた: LP制作にあたって、課題点はございましたか？
								</p>
								<p className="mt-4">
									Byeバイト担当者様:
									予算を抑えつつ、サービスの魅力を最大限に伝えることでした。また、ターゲット層である学生やアルバイトの方に響くデザインやコピーにすることも課題でした。
								</p>
								<p className="mt-4">
									あなた:
								...
								<p className="mt-4">
									Byeバイト担当者様:
									実績と提案力に魅力を感じました。私たちの要望をしっかりと理解してくださり、最適なLPを制作していただけると確信しました。
								</p>
							</section>
							...
							<section id="制作の過程" className="pt-8">
								...
								<p className="mt-4">
									Byeバイト担当者様:
									サイトのキャッチコピーについて、何度も議論を重ねたことが印象に残っています。「働く選択を、もっと自由に」という言葉に決まった時は、本当に感動しました。
								</p>
								<p className="mt-4">あなた: こだわった点はありますか？</p>
								<p className="mt-4">
									Byeバイト担当者様:
									ターゲット層である学生やアルバイトの方に響くデザイン、コピー、そしてメッセージにこだわりました。また、サービスの信頼性を高めるために、実績やお客様の声も掲載しました。
								</p>
							</section>
							...
							<section id="Webサイト完成後の反響" className="pt-8">
								...
								<p className="mt-4">
									あなた:
									サイト流入数200%向上、素晴らしいですね！Byeバイトへの影響はいかがですか？
								</p>
								<p className="mt-4">
									Byeバイト担当者様:
							...
							<section id="今後の展望" className="pt-8">
								...
								<div className="mt-2 bottom-0 left-0 right-0 border-b border-gray-200" />
								<p className="mt-4">
									あなた: 今後の展望について教えていただけますでしょうか？
								</p>
								<p className="mt-4">
									Byeバイト担当者様:
									より多くの方にサービスを知っていただくために、SNSや広告を活用していきたいと考えています。また、お客様の声をもとに、サービスのさらなる充実を図っていきます。
								</p>
								<p className="mt-4">
									あなた:
